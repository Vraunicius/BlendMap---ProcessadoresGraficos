...
public class MultiTexture implements Scene {
    private static final String PATH = "/Users/vinil/Desktop/img/opengl/";
    ...
    public void init() {
        ...
        try {
            mesh = MeshFactory.loadTerrain(new File(PATH + "heights/BlendMap.jpg"), 0.4f, 3);
        } catch (IOException e) {
        ...
        material = new MultiTextureMaterial(
                ...
                0.0f);                          //specular power
        material.setTextures(new Texture(PATH + "textures/bricks_t.jpg"),
        new Texture(PATH + "textures/brickwall_t.jpg"),
        new Texture(PATH + "textures/lunarrock_t.png"),
        new Texture(PATH + "textures/stone_t.png"));
